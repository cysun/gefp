...
public class ADUser {
    ...
    public ADUser( Attributes attr ) throws javax.naming.NamingException
    {
     ...
     *            false, ensure that the LDAPS certificate has been imported
     *            into a trust store and sourced before calling this method.
        ...
        throws java.io.IOException, NamingException
    {
        ...
        try
        {
            ...
            modificationItems[0] = new ModificationItem(
                DirContext.REMOVE_ATTRIBUTE, new BasicAttribute( "unicodePwd",
                    getPassword( oldPass ) ) );
