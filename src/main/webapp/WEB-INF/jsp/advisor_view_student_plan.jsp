					...
					<div class="col-md-12 col-sm-12 col-xs-12">
						...
						<div class="panel panel-default">
							<div class="panel-heading">
								<div class="">
									<h5>Student Name : ${currUserObj.firstName} ${currUserObj.lastName}</h5>
								</div>
								<div class="">
								...
								<div class="col-xs-offset-5 ">
								      <div id="successMessage" style="color:#090;display:none;"><h5>Checkpoints updated successfully</h5></div>
								</div>
